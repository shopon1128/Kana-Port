...
## 記入例: 「隊員がはぐれる」の正体はダウンだった (2026-07-15)
- 症状: 分隊から1〜2体が離れてその場に留まる。地形を変えてから起きるようになった
- 原因: **はぐれではなく、撃たれてダウンしていた**。地形変更で敵と接敵するようになったのが引き金。ダウンした隊員は移動を止めるだけで、見た目は立ったままだったため、はぐれと区別がつかなかった
- 解決: ダウンしたら横倒しにし、ログを出し、HUDに「健在/ダウン/足止め」の内訳を表示した。1回の再生で即座に切り分けられるようになった
- 教訓: **状態が違うのに見た目が同じだと、症状の説明そのものが誤る**。この件では私(Claude)が実機を見られないまま推測で2回修正し、どちらも的外れだった。再現できない不具合では、修正より先に「状態を区別できる表示」を入れるほうが速い
